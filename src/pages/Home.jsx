    ...
    <div>
      ...
      >
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10 items-center relative mt-[5rem]">
          <div className="space-y-6 mb-3 xl:mb-0">
            ...
            <Link
              to="/joinus"
              className=" flex items-center gap-2 bg-white text-blue-600 font-bold py-1.5 px-3 rounded-full transition duration-300 w-max hover:bg-gray-100 z-40"
            >
              <span>join Us</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2  w-full">
        <div className="bg-white flex items-center justify-center py-3 px-6">
          <div className="bg-gray-100 shadow-lg rounded-full px-6 py-3 text-center text-sm md:text-base font-medium text-gray-800">
      ...
      <div className="px-10 py-10">
        ...
        <h2 className="flex flex-col sm:flex-row items-start sm:items-center text-lg sm:text-2xl gap-2">
          <span className="font-bold bg-red-600 text-white px-2 py-1 rounded-tr-full rounded-br-full">
      ...
      <div className="my-1.5">
        ...
        <div className="flex justify-center mt-6 mb-12">
          <Link
            to="/events"
            className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-medium py-1.5 px-3 rounded-full transition duration-300 w-max"
          >
      ...
      <section className="w-full px-4 md:px-12 py-6">
        ...
        <h2 className="flex flex-col sm:flex-row items-start sm:items-center text-lg sm:text-2xl  gap-2">
          <span className="font-bold bg-red-600 text-white px-2.5 py-1 rounded-tr-full rounded-br-full">
            Our Committees
          </span>
          <span className="text-[#1A1A1A] mx-1">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:w-2/3 w-full bg-gray-100 rounded-xl p-6">
